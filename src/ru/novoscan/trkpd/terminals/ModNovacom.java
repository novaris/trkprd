...
public class ModNovacom extends Terminal {
	...
	private static final Pattern Pattern_ACK = Pattern
			.compile("\\+ACK:GT.+," + ",([0-9A-Fa-f]{6})" + // Version
					",(\\d{0,15})" + // IMEI
					",.*" + ",(\\d{14}),([0-9A-Fa-f]{4})\\$");
	 ...
	 */
	/*
	 * +RESP:GTDOG,0A0100,135790246811220,,0,0,1,1,4.3,92,70.0,121.354335,31.
	 * 222073 ,20090214013254,0460,0000,18d8,6141,00,2000.0,20090214093254,11F0$
	 */
	...
	/*
	 * +RESP:GTLBC,0A0100,135790246811220,,+8613800000000,1,4.3,92,70.0,121.
	 * 354335
	 * ,31.222073,20090214013254,0460,0000,18d8,6141,00,,20090214093254,11F0$
	 */
	...
	/*
	 * +RESP:GTINF,0A0100,135790246811220,,41,898600810906F8048812,16,0,0,0,,4.
	 * 10 ,0,0,0,0,20100214013254,,,,+0800,0,20100214093254,11F0$
	 */
	...
	/*
	 * +RESP:GTGPS,0A0100,135790246811220,,0,1F,1F,0,0,20100214013254,
	 * 20100214093254 ,11F0$
	 */
	...
	/*
	 * +RESP:GTALL,0A0100,135790246811220,,BSI,cmnet,,,,,,,SRI,4,,1,116.226.44.
	 * 17 ,9001,116.226.44.16
	...
	/*
	 * +RESP:GTCID,0A0100,135790246811220,,898600810906F8048812,20100214093254,
	 * 11F 0$
	 */
	...
	/*
	 * +RESP:GTBPL,0A0100,135790246811220,,3.53,0,4.3,92,70.0,121.354335,31.
	 * 222073 ,20090214013254,0460,0000,18d8,6141,00,0.0,20100214093254,11F0$
	 */
	...
	/*
	 * +RESP:GTSTT,0A0100,135790246811220,,41,0,4.3,92,70.0,121.354335,31.
	 * 222073, 20090214013254,0460,0000,18d8,6141,00,0.0,20100214093254,11F0$
	 */
	...
	/*
	 * +RESP:GTGSM,0A0100,011874000103767,FRI,0460,0000,1878,0871,20,,0460,0000,
	 * 1878 ,
	...
	private void parsePacket() throws ParseException {
		...
		if (Pattern_ACK.matcher(packet).matches()) {
			...
			m.matches();
			logger.error(
					"Не обрабатываемый запрос ACK UID : " + getUID(m.group(3)));
